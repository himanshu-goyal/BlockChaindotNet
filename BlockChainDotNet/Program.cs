...
namespace BlockChainDotNet
{
    class Program
    {
        ...
        {
            BlockChain.ServiceLayer.BlockChain blockChain = new BlockChain.ServiceLayer.BlockChain();
            Block block1 = new Block(30.00, "111", "Mouse", DateTime.Now, PaymentType.Borrow, 1, null);
